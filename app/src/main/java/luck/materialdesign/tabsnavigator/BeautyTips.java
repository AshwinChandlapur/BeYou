...
import luck.materialdesign.tabsnavigator.tabs.all.Tabs_BeautyTips.BeautyTips_ViewPagerAdapter;
...
public class BeautyTips extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BeautyTips.this,MainActivity.class);
        ...
        askAway.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(BeautyTips.this,AskAway.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void init_slider() {
        ...
        adapter =  new BeautyTips_ViewPagerAdapter(getSupportFragmentManager(),Titles,Numboftabs);
    ...
    private void init_navigator(){
        // Navigation Drawer
        mDrawerLayout = (DrawerLayout) findViewById(R.id.beautyTips_activity_DrawerLayout);
